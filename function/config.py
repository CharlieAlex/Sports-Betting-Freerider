...
img_url_dict = {
    ...
    "MLB": "https://img.mlbstatic.com/mlb-images/image/upload/t_16x9/t_w1024/mlb/rwddj1rp5oirwwdqgfdl",
}

help_text = """請輸入以下格式進行爬蟲: 目標 資料範圍 爬取數量 郵件帳號1 郵件帳號2...
e.g. NBA thismonth 15 aaa@gmail.com bbb@gmail.com

目標包含: NBA, 歐洲職籃, 韓國職籃, 中國職籃, 日本職籃, 澳洲職籃, 澳洲職棒, 足球, NHL冰球, 俄羅斯冰球, 賽馬, 美式足球, MLB。
